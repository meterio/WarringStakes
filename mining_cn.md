...
以下是在 Meter 测试网络上不同比特币矿机的大致生产参数，以蚂蚁S9矿机为例，挖1个MTR平均需要消耗10度电，在Meter早期测试网上我们会按照S9矿机设置。在主网上线的时候我们会把1 MTR = 10度电标准调整到新型矿机的能耗比水平。从矿工的角度，如果MTR的毛利高于比特币和各种比特币分叉，就值得挖MTR。和挖比特币不同的地方是每天挖到币的数量和全网总体算力的涨跌无关，矿工可以清楚地知道每天能挖到多少个币。

|                      | 功率  | 算力  | 能耗比     | 每天产量   | 利润率指数    |
|----------------------|-------|------|------------|-----------|--------------|
| AntMiner S9          | 1323  | 13.5 | 98         | 3.17      | 1.00         |
| WhatsMiner M10       | 3500  | 55   | 63.64      | 12.93     | 1.54         |
| Inno Silicon T3+ 52T | 2200  | 52   | 42.31      | 7.94      | 2.32         |
| AntMiner S17Pro      | 2094  | 53   | 39.51      | 8.09      | 2.48         |
